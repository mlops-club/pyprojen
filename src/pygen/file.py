...
from pygen.util import is_writable, normalize_persisted_path, try_read_file_sync, write_file
from pygen.util.constructs import find_closest_project
...
class FileBase(Component, ABC):
    ...
    def marker(self) -> Optional[str]:
        ...
        if self.project.ejected or not self._should_add_marker:
            return None
        return f"DO NOT EDIT. Generated by pygen. To modify, edit .pygenrc.py and run 'python .pygenrc.py'."
